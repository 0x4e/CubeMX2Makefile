...
######################################
OPENOCD           ?= openocd
#OPENOCD_INTERFACE ?= interface/ftdi/olimex-jtag-tiny.cfg
...
# DSP Lib path
DSP_LIB_DIR = Drivers/CMSIS/DSP/build/
